...
{
    public class ShippingCompanyConfiguration : AuditableEntityConfiguration<ShippingComapny>
    {
        public override void Configure(EntityTypeBuilder<ShippingComapny> builder)
        {
